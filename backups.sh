...
set +u
CONF_OVERRIDE_ALT=$CONF_OVERRIDE
BACKUPS_PATH_OVERRIDE_ALT=$BACKUPS_PATH_OVERRIDE
BACKUPS_PATH_ALT=$BACKUPS_PATH
set -u

CONF_OVERRIDE=$CONF_OVERRIDE_ALT
BACKUPS_PATH_OVERRIDE=$BACKUPS_PATH_OVERRIDE_ALT
BACKUPS_PATH=$BACKUPS_PATH_ALT

if test "$CONF_OVERRIDE"; then
    CONF=$CONF_OVERRIDE
else
    CONF=$PWD/conf
fi

if test "$BACKUPS_PATH_OVERRIDE"; then
    BACKUPS_PATH=$BACKUPS_PATH_OVERRIDE
elif test ! "$BACKUPS_PATH"; then
